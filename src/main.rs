...
const MODEL_PATH: &str = "/Users/pavel/Library/Application Support/com.bradenwong.whispering/models/whisper/ggml-large-v3-turbo.bin";
...
impl RecorderState {
    ...
    fn start_new_recording(&mut self) -> Result<()> {
        self.close_session()?;
    ...
    fn stop_recording(&mut self) -> Result<AudioRecording> {
        let tx = self
            .cmd_tx
            .as_ref()
...
fn transcribe_wav_file(model_manager: &ModelManager, file_path: &PathBuf) -> Result<String> {
